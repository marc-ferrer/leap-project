...
const saveAs = window.saveAs
  ...
  let URL = view.URL || view.webkitURL || view
  let save_link = doc.createElementNS('http://www.w3.org/1999/xhtml', 'a')
  let can_use_save_link = !view.externalHost && 'download' in save_link
  let click = function(node) { // eslint-disable-line
  ...
  let req_fs = view.requestFileSystem || webkit_req_fs ||
  ...
  let fs_min_size = 0
  let deletion_queue = []
  let process_deletion_queue = function() {
  ...
  let FileSaver = function(blob, name) {
      ...
      let create_if_not_found = {create: true, exclusive: false}
      let slice;
      ...
      req_fs(view.TEMPORARY, fs_min_size, abortable(function(fs) {
        fs.root.getDirectory('saved', create_if_not_found, abortable(function(dir) { // eslint-disable-line
          let save = function() {
